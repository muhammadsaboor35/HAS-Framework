 ...
 * @version 1.0
 */
public class LightSensorDevice extends Device
{
     ...
     */
    public LightSensorDevice( int id, Room room, String displayName, Pin pin, DeviceController dc ) throws Exception
    {
